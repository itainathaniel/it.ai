...
<div class="container mx-auto flex text-center">
	<div class="w-screen lg:w-2/5 mx-auto mt-4 p-4 text-lg lg:text-sm bg-white rounded shadow-lg text-grey-darkest">
		<img class="w-48 h-48 rounded-full my-6" src="{{ asset('images/profile_pic.png') }}" alt="Itai Nathaniel's avatar">
		<ul class="list-reset leading-loose">
			<li class="leading-normal">
				I'm <span class="text-lg lg:text-xl">Itai Nathaniel</span>, a fullstack web developer (and also a pâtissier & a pilot) from Tel Aviv, Israel. I'm a senior developer in <a href="https://exampal.com">examPAL</a>, married to Chen and father to Ilil.
			</li>
			<li>
		...
		<ul class="list-reset flex flex-row justify-center">
			<li class="m-0 px:0 lg:px-4 lg:m-2">
